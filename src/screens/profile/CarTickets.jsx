...
export const CarTickets = ({ carTicket, carLoading }) => {
  if (carLoading) return  <div className="text-4xl w-full flex items-center justify-center py-20"> <FaSpinner /></div>
  else if(carTicket.length === 0 ) return <span>sorry you not reservation private trip yet . </span>
  return (
