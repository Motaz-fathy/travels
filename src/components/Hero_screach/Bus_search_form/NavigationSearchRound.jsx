...
import { StoreEndDateAction, search_bus_trip } from "../../../redux/actions/bus_travel_actions/bus_travel_actions";
...
export const NavigationSearchRound = ({
    ...
    useEffect(() => {
        if (onSelect_from === null || onSelect_to === null || !startDate || !endDate) {
          ...
          dispatch(StoreEndDateAction(endDate))
          setDisable(false);
        }
      }, [onSelect_from, onSelect_to, startDate , endDate]);
