...
export const Navigation_search = () => {
  ...
  return (
    <div className="w-2/3 max-sm:w-full   flex flex-col items-center shadow-xl bg-gray-900 bg-opacity-20 py-2 px-2 rounded-xl absolute top-1/3 max-md:top-30 mx-auto left-0 right-0 ">
      {/* nav search  */}
