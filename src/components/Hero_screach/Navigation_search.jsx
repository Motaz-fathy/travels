...
export const Navigation_search = () => {
  ...
  return (
    <div className="w-2/3 max-sm:w-full   flex flex-col items-center shadow-xl bg-gray-500 bg-opacity-20 p-2 rounded-xl absolute top-1/2 mx-auto left-0 right-0">
      {/* nav search  */}
          ...
          >
            <g clip-path="url(#clip0_574_6625)">
              <path
                ...
                fill={lable === "maritime" ? "white" : "black"}
              />
              <path
      ...
      <div className="hidden max-md-flex max-sm:flex w-full justify-between items-center ">
        <Slider>
          <div
            className={`w-32  flex justify-center items-center rounded-2xl  transform duration-200 ease-in-out cursor-pointer px-20 py-2  
          ${lable === "bus" ? "bg-gray-800 text-white" : "bg-gray-200"}`}
            onClick={() => set_lable("bus")}
          >
            bus
