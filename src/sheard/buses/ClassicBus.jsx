...
export const ClassicBus = ({ setSelectedList , selectedList, seats , reservationSeats , trip , filterSelectedSeats}) => {
  ...
  return (
	<div className="mt-4 " dir="ltr">
		<h3 className="w-full text-2xl font-semibold">{"selectSeats"}</h3>
